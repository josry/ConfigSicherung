...
cmsRun fromEDM2GEN.py input=/storage/c/josmet/EtpFreiburgDesyEtp/MSSM-Files/lhe2edm-Files/lhe2edm-${4}-m${4}${1}_tb${2}_${3}.root output=./edm2gen-${4}-m${4}${1}_tb${2}_${3}.root jobnum=${5}
